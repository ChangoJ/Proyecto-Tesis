...
var HorarioScheme = Schema({
    ...
    semestre: String,
    dia: Array,
    idTabla: [{ idAsignatura: String, idAula: String }],
    horas: [{ horaInicio: String, horaFin: String }],
    item: [ {asignatura: { type: mongoose.Schema.Types.ObjectId, ref: 'Asignatura', autopopulate: true }, aula: { type: mongoose.Schema.Types.ObjectId, ref: 'Aula', autopopulate: true} }],
