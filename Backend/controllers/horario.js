...
var controller = {
    ...
    save: (req, res) => {
        ...
        if (validate_tipoHorario && validate_carrera && validate_estado && validate_semestre
            ...
            //guardar el articulo
            horario1.save().then((horarioStored) => {
    ...
    getHorario: (req, res) => {
        ...
        var horarioIdValid = mongoose.Types.ObjectId.isValid(horarioId);
        ...
        if (horarioIdValid) {
            ...
            if (!horarioId || horario == null) {
                ...
                horario.findById(horarioId).then((horario) => {
    ...
    delete: (req, res) => {
        ...
        horario.findByIdAndDelete({ _id: horarioId }).then((horarioRemoved) => {
    ...
    search: (req, res) => {
        ...
        horario.find({
            "$or": [
                {
                    "tipoHorario": { "$regex": searchString, "$options": "i" }
                }
                ,
